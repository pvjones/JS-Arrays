...
function divider(numbersArray) {
  dividedArr = [];
  dividedArr.push(evenFinder(numbersArray.slice()));
  dividedArr.push(oddFinder(numbersArray.slice()));
  return dividedArr;
};
...
var user2 = {
  name: 'Paul Jones',
  email: 'paulvjones@gmail.com',
  password: 'roachmonkey',
  username: 'roachcake'
};
var user3 = {
  name: 'Bob Dylan',
